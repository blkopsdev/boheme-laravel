...
class TextFirstFeedbackMail extends Mailable
{
     ...
     * @return void
     */
    public function __construct(Project $project, User $user, TextFirstFeedback $form)
    {
    ...
    public function build()
    {
        $message = $this->from($this->user->email, $this->user->name)
            ->view('emails.text_first_feedback')
