...
class LogoFinalFeedbackMail extends Mailable
{
     ...
     * @return void
     */
    public function __construct(Project $project, LogoFinalFeedback $form, User $user)
    {
    ...
    public function build()
    {
        $message = $this->from($this->user->email, $this->user->name)
            ->view('emails.logo_final_feedback')
