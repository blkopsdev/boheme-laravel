...
class WebshopOnboardingMail extends Mailable
{
     ...
     * @return void
     */
    public function __construct(Project $project, User $user, WebshopOnboarding $form)
    {
    ...
    public function build()
    {
        $message = $this->from($this->user->email, $this->user->name)
            ->view('emails.webshop_onboarding')
