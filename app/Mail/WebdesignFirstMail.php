...
class WebdesignFirstMail extends Mailable
{
     ...
     * @return void
     */
    public function __construct(Project $project, User $user, WebdesignFirstVersion $form)
    {
    ...
    public function build()
    {
        $message = $this->from($this->user->email, $this->user->name)
            ->view('emails.webdesign_first_version')
