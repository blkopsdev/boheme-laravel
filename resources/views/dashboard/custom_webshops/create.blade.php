@extends('layouts.spaces.dashboard', ['activePage' => 'custom_webshops', 'activePanel' => 'dashboard'])
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <form class="form" method="POST" action="{{ route('custom_webshop.store') }}">
            @csrf
            <div class="card py-5">
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="webdesign_onboarding">@lang('app.webdesign_onboarding')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_onboarding" id="webdesign_onboarding">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_version_1" id="webdesign_version_1">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_version_2" id="webdesign_version_2">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_completed" id="webdesign_completed">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_dev" id="webdesign_dev" checked>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="first_home" id="first_home" checked>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
