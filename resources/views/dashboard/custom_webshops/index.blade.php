...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <h2><span class="mr-3">{{ $title }}</span> <a href="{{ route('custom_webshop.create') }}" class="btn btn-success btn-round"><i class="material-icons">add</i>@lang('app.add_project')</a></h2>
        </div>
      </div>
              ...
              <table class="table table-hover project-list text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ route('custom_webshop.show', $project->id) }}" class="btn bg-white text-dark btn-round view-btn"> View &nbsp;<span class="material-icons">visibility</span></a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
