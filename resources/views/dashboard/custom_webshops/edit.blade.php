@extends('layouts.spaces.dashboard', ['activePage' => 'custom-webshops', 'activePanel' => 'dashboard'])
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <form class="form" method="POST" action="{{ route('custom_webshop.update', $project->id) }}">
            @csrf
            <div class="card py-5">
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webshop_onboarding" id="webshop_onboarding" {{ in_array('webshop_onboarding', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="content_adding" id="content_adding" {{ in_array('content_adding', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
