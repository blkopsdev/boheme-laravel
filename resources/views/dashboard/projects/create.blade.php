          ...
          <form class="form" method="POST" action="">
            ...
            <div class="card py-5">
              ...
              <div class="bmd-form-group{{ $errors->has('note') ? ' has-danger' : '' }} mt-3">
                ...
                <div class="input-group col-md-8 offset-md-1">
                  <textarea name="note" class="form-control ckeditor" id="note">{{ old('note') }}</textarea>
                  @if ($errors->has('note'))
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="onboarding" id="first_version" checked>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
