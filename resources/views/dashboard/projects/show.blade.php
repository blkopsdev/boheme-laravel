@extends('layouts.spaces.dashboard', ['activePage' => 'dashboard', 'activePanel' => 'dashboard', 'titlePage' => __('Dashboard')])
    ...
    <div class="container-fluid">
      ...
      <div class="row bg-white project-status-bar">
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <a href="{{ route('edit_project', $project->id) }}" class="btn btn-success text-white">@lang('app.change_data')</a>
        </div>
      </div>
    </div>
    <div class="row">
                  ...
                  <tbody>
                    ...
                    <tr class="timeline {{ ($project->logoFeedbackFirst != null && $project->logoFeedbackFirst->sent_email == 1) ? '': 'inactive'}}">
                      ...
                      <td>
                        ...
                        @else
                        <p class="{{ ($project->logoFeedbackFirst && $project->logoFeedbackFirst->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                    ...
                    @endif
                    @if (in_array('onboarding', $available_status))
                    <tr class="timeline {{ ($project->websiteOnboarding != null && $project->websiteOnboarding->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->websiteOnboarding != null && $project->websiteOnboarding->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.onboarding')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('onboarding'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('onboarding')->deadline }}" data-id="{{ $project->deadlineBySlug('onboarding')->id }}">{{ $project->deadlineBySlug('onboarding')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->websiteOnboarding && $project->websiteOnboarding->status == 1)
                        <a href="{{ route('onboarding_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->websiteOnboarding && $project->websiteOnboarding->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->websiteOnboarding && $project->websiteOnboarding->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('onboarding'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="onboarding"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->websiteOnboarding && $project->websiteOnboarding->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('onboarding', ['id' => $project->websiteOnboarding->id, 'token' => $project->websiteOnboarding->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="onboarding" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
        ...
        <div class="panel">
          ...
          <div class="panel-item bg-white my-3">
            ...
            <div class="document-table row">
              <div class="col-md-12 table-responsive">
                <table class="table table-hover" id="document_files">
                  <thead>
                    <tr>
                      <th><strong>@lang('app.name')</strong></th>
          ...
          <div class="panel-item bg-white my-3">
            ...
            <div class="comment-list">
              ...
              <div class="comments-item">  
                <div class="comment_image">
                  ...
                  {{-- <img src="{{asset('assets/img/profile_logo.png')}}" class="img-fluid"> --}}
                </div>
            ...
            <div class="new-comment mt-3">
              <form id="commentform">
                @csrf
                <textarea name="comment" id="comment" rows="4" tabindex="4" placeholder=""></textarea>
...
@include('components.modals.calendar', ['page' => 'website'])
      ...
      $('#delete-project').click(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            toastr.success(data.msg, '@lang("app.success")', toastr_options);
            setTimeout(function() {
              window.location.href = '{{ route("websites") }}'
            }, 2000)
          }
        });
