@extends('layouts.spaces.dashboard', ['activePage' => 'custom_websites', 'activePanel' => 'dashboard'])
          ...
          <form class="form" method="POST" action="">
            ...
            <div class="card py-5">
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="web_design">@lang('app.webdesign')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="web_design" id="web_design" {{ in_array('web_design', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="webdesign_version_1">@lang('app.webdesign_version_1')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_version_1" id="webdesign_version_1" {{ in_array('webdesign_version_1', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="webdesign_version_2">@lang('app.webdesign_version_2')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_version_2" id="webdesign_version_2" {{ in_array('webdesign_version_2', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="webdesign_completed">@lang('app.webdesign_completed')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_completed" id="webdesign_completed" {{ in_array('webdesign_completed', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="webdesign_dev">@lang('app.webdesign_dev')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="webdesign_dev" id="webdesign_dev" {{ in_array('webdesign_dev', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  <div class="col-md-6 offset-md-1">
                    <label for="first_home">@lang('app.first_home')</label>
                  </div>
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="first_home" id="first_home" {{ in_array('first_home', json_decode($project->available_status)) ? 'checked' : '' }}>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-3 ">
                <div class="col-md-8 offset-md-1">
                  <button type="submit" class="btn btn-success btn-round">@lang('app.save_changes')</button>
                </div>
              </div>
            </div>
          </form>
