    ...
    <div class="container-fluid">
      ...
      <div class="row bg-white project-status-bar">
        ...
        <div class="col-lg-4 col-md-4">
          ...
          <a href="{{ route('edit_custom_website', $project->id) }}" class="btn btn-success text-white">@lang('app.change_data')</a>
        </div>
      </div>
    </div>
    <div class="row">
        ...
        <div class="panel">
          <div class="panel-item bg-white my-3">
              <div class="client-info my-2">
                ...
                <table class="col-md-12 table table-striped table-hover table-borderless">
                  <tbody>
                    <tr>
                ...
                <table class="col-md-12 ml-2 my-4">
                  ...
                  <tbody>
                    ...
                    <tr class="timeline {{ ($project->logoFeedbackFirst != null && $project->logoFeedbackFirst->sent_email == 1) ? '': 'inactive'}}">
                      ...
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->logoFeedbackFirst && $project->logoFeedbackFirst->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                    ...
                    <tr class="timeline {{ ($project->logoFeedbackFinal != null && $project->logoFeedbackFinal->sent_email == 1) ? '': 'inactive'}}">
                      ...
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->logoFeedbackFinal && $project->logoFeedbackFinal->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                          <span class="material-icons">
                              add
                            </span>
                    ...
                    @endif
                    @if (in_array('web_design', $available_status))
                    <tr class="timeline {{ $project->logoDesign? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->webDesign != null && $project->webDesign->sent_email == 1) ? '': 'inactive'}} ">
                      <td><strong>@lang('app.web_design')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('web_design'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('web_design')->deadline }}" data-id="{{ $project->deadlineBySlug('web_design')->id }}">{{ $project->deadlineBySlug('web_design')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->webDesign && $project->webDesign->status == 1)
                        <a href="{{ route('webdesign_pdf', $project->webDesign->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->webDesign && $project->webDesign->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->webDesign && $project->webDesign->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('web_design'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="web_design"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->webDesign && $project->webDesign->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('web_design', ['id' => $project->webDesign->id, 'token' => $project->webDesign->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="web_design" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('webdesign_version_1', $available_status))
                    <tr class="timeline {{ ($project->webdesignFirstVersion != null && $project->webdesignFirstVersion->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->webdesignFirstVersion != null && $project->webdesignFirstVersion->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.webdesign_version_1')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('webdesign_version_1'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('webdesign_version_1')->deadline }}" data-id="{{ $project->deadlineBySlug('webdesign_version_1')->id }}">{{ $project->deadlineBySlug('webdesign_version_1')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->webdesignFirstVersion && $project->webdesignFirstVersion->status == 1)
                        <a href="{{ route('webdesign_first_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->webdesignFirstVersion && $project->webdesignFirstVersion->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->webdesignFirstVersion && $project->webdesignFirstVersion->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('webdesign_version_1'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="webdesign_version_1"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->webdesignFirstVersion && $project->webdesignFirstVersion->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('webdesign_version_1', ['id' => $project->webdesignFirstVersion->id, 'token' => $project->webdesignFirstVersion->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="webdesign_version_1" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('webdesign_version_2', $available_status))
                    <tr class="timeline {{ ($project->webdesignFinalVersion != null && $project->webdesignFinalVersion->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->webdesignFinalVersion != null && $project->webdesignFinalVersion->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.webdesign_version_2')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('webdesign_version_2'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('webdesign_version_2')->deadline }}" data-id="{{ $project->deadlineBySlug('webdesign_version_2')->id }}">{{ $project->deadlineBySlug('webdesign_version_2')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->webdesignFinalVersion && $project->webdesignFinalVersion->status == 1)
                        <a href="{{ route('webdesign_final_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->webdesignFinalVersion && $project->webdesignFinalVersion->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->webdesignFinalVersion && $project->webdesignFinalVersion->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                          <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('webdesign_version_2'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="webdesign_version_2"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->webdesignFinalVersion && $project->webdesignFinalVersion->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('webdesign_version_2', ['id' => $project->webdesignFinalVersion->id, 'token' => $project->webdesignFinalVersion->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="webdesign_version_2" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('webdesign_completed', $available_status))
                    <tr class="timeline {{ ($project->webdesignCompleted != null && $project->webdesignCompleted->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->webdesignCompleted != null && $project->webdesignCompleted->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.webdesign_completed')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('webdesign_completed'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('webdesign_completed')->deadline }}" data-id="{{ $project->deadlineBySlug('webdesign_completed')->id }}">{{ $project->deadlineBySlug('webdesign_completed')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if (!$project->webdesignCompleted)
                        <p class="{{ $project->webdesignCompleted? 'text-success': ''}} font-weight-bold">Pending</p>
                        @elseif($project->webdesignCompleted && $project->webdesignCompleted->status == 0)
                        <p class="{{ $project->webdesignCompleted? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->webdesignCompleted && $project->webdesignCompleted->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('webdesign_completed'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="webdesign_completed"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->webdesignCompleted && $project->webdesignCompleted->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="webdesign_completed" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('webdesign_dev', $available_status))
                    <tr class="timeline {{ ($project->webdesignDev != null && $project->webdesignDev->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->webdesignDev != null && $project->webdesignDev->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.webdesign_dev')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('webdesign_dev'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('webdesign_dev')->deadline }}" data-id="{{ $project->deadlineBySlug('webdesign_dev')->id }}">{{ $project->deadlineBySlug('webdesign_dev')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->webdesignDev && $project->webdesignDev->status == 1)
                        <a href="{{ route('webdesign_dev_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->webdesignDev && $project->webdesignDev->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->webdesignDev && $project->webdesignDev->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('webdesign_dev'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="webdesign_dev"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->webdesignDev && $project->webdesignDev->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('webdesign_dev', ['id' => $project->webdesignDev->id, 'token' => $project->webdesignDev->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="webdesign_dev" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('first_home', $available_status))
                    <tr class="timeline {{ ($project->firstHome != null && $project->firstHome->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->firstHome != null && $project->firstHome->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.first_home')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('first_home'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('first_home')->deadline }}" data-id="{{ $project->deadlineBySlug('first_home')->id }}">{{ $project->deadlineBySlug('first_home')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->firstHome && $project->firstHome->status == 1)
                        <a href="{{ route('first_home_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->firstHome && $project->firstHome->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ ($project->firstHome && $project->firstHome->sent_email == 1) ? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                          aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('first_home'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="first_home"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->firstHome && $project->firstHome->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('first_home', ['id' => $project->firstHome->id, 'token' => $project->firstHome->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="first_home" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
                    ...
                    @endif
                    @if (in_array('text_adding', $available_status))
                    <tr class="timeline {{ ($project->textAdding != null && $project->textAdding->sent_email == 1) ? '': 'inactive'}}">
                      <td>
                        <ul style="margin-bottom:0;"><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li><li style="line-height: 0.7"></li></ul>
                      </td>
                      <td></td>
                    ...
                    <tr class="timeline {{ ($project->textAdding != null && $project->textAdding->sent_email == 1) ? '': 'inactive'}}">
                      <td><strong>@lang('app.text_adding')</strong></td>
                      <td>
                        @if ($project->deadlineBySlug('text_adding'))
                        <button class="btn btn-round bg-white text-dark deadline" data-toggle="modal" data-target="#deadlineUpdate" data-value="{{ $project->deadlineBySlug('text_adding')->deadline }}" data-id="{{ $project->deadlineBySlug('text_adding')->id }}">{{ $project->deadlineBySlug('text_adding')->deadline }}</button>    
                        @endif
                      </td>
                      <td>
                        @if ($project->textAdding && $project->textAdding->status == 1)
                        <a href="{{ route('textadding_pdf', $project->id) }}" class="text-success font-weight-bold">Download</a>
                        @else
                        <p class="{{ ($project->textAdding && $project->textAdding->sent_email == 1) ? 'text-success': ''}} font-weight-bold">Pending</p>
                        @endif
                      </td>
                      <td>
                        <div class="btn-group dropleft">
                          <button type="button" class="btn {{ $project->textAdding? 'btn-success': ''}} dropdown-toggle btn-round p-0" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <span class="material-icons">
                              add
                            </span>
                          ...
                          <div class="dropdown-menu">
                            @if (!$project->deadlineBySlug('text_adding'))
                            <a class="dropdown-item" data-toggle="modal" data-target="#addDeadline" data-status-slug="text_adding"><strong>@lang('app.set_deadline')</strong></a>
                            @endif
                            <a class="dropdown-item" data-toggle="modal" data-target="#create_todo"><strong>@lang('app.add_to_do')</strong></a>
                            @if ($project->textAdding && $project->textAdding->sent_email == 1)
                            <a class="dropdown-item" href="#"><strong>@lang('app.add_project')</strong></a>
                            <a class="dropdown-item copy-link" href="{{ route('text_adding', ['id' => $project->textAdding->id, 'token' => $project->textAdding->token]) }}"><strong>@lang('app.copy_form_link')</strong></a>
                            <div class="dropdown-divider"></div>
                            <span class="dropdown-item resend-email" data-status="text_adding" data-project="{{ $project->id }}"><strong>@lang('app.resend_email')</strong></span>
                            @endif
                          </div>
                        </div>
                      </td>
...
@include('components.modals.calendar', ['page' => 'custom_website'])
...
<script src="//cdn.ckeditor.com/4.15.1/standard/ckeditor.js"></script>
  <script>
    ...
    $(document).ready(function() {
      $('#delete-project').click(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            toastr.success(data.msg, '@lang("app.success")', toastr_options);
            setTimeout(function() {
              window.location.href = '{{ route("custom_websites") }}'
            }, 2000)
          }
        });
      ...
      $(document).on('submit', 'form.delete-file', function(event) {
        event.preventDefault();
        var id = $(this).find('input[name="file_id"]').val();
