            ...
            <div class="card py-5">
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="web_design" id="web_design">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
              ...
              <div class="bmd-form-group mt-2">
                <div class="input-group">
                  ...
                  <div class="col-md-4">
                    <label class="switch">
                      <input type="checkbox" class="info" name="status[]" value="text_adding" id="text_adding" checked>
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
