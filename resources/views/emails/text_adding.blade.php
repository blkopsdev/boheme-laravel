...
<p>U kunt de input via de volgende link aanleveren: <a href="{{ route('text_adding', ['id' => $form['id'], 'token' => $form['token']]) }}">{{ route('text_adding', ['id' => $form['id'], 'token' => $form['token']]) }}</a></p>
