  ...
  <main>
    <div class="content">
      <div class="container-fluid">
        <h1><strong>Website </strong>| Feedback</h1>
        <p><strong>Company</strong>: {{$data->project->company_name}}</p>
        <p><strong>Testserver URL</strong>:  <a href="{{$data->project->testing_url}}" target="_blank">{{$data->project->testing_url}}</a></p><br>
        <p><strong>WP Access:</strong></p>
        <p>User: Developer</p>
        <p>Password: Dev123Sup123!</p>
