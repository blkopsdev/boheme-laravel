			...
			<div class="col-md-12">
				<section>
					<div class="wizard">
						...
						<form method="POST" enctype="multipart/form-data" action="" class="multistep webshop-onboarding">
							...
							<div class="tab-content">
								<div class="tab-pane active" role="tabpanel" id="step0">
									<div class="tab-pane-title py-100">
										<h1 class="text-dark-light" style="font-size:50px;">@lang('app.webshop_onboarding')</h1>
								...
								<div class="tab-pane" role="tabpanel" id="step1">
									<div class="row">
										<div class="form-group {{ $errors->has('company_name') ? ' has-danger' : '' }} col-md-6 col-md-offset-3 mt-30">
										...
										<div class="form-group {{ $errors->has('slogan') ? ' has-danger' : '' }} col-md-6 col-md-offset-3 mt-30 mb-30">
								...
								<div class="tab-pane" role="tabpanel" id="step2">
									<div class="row mb-30">
										<h2 class="text-dark-light">@lang('form.describe_niche')</h2>
										<div class="form-group {{ $errors->has('niche') ? ' has-danger' : '' }} col-md-8 col-md-offset-2 mt-30">
											<textarea name="niche" id="niche" class="form-control{{ $errors->has('niche') ? ' is-invalid' : '' }}" rows="5" placeholder="Type hier uw antwoord, beschrijf wat voor producten u verkoopt">{{ $form->niche ? $form->niche:old('niche') }}</textarea>
								...
								<div class="tab-pane" role="tabpanel" id="step3">
									<div class="row no-mh">
										<h2 class="mb-30 text-dark-light">Wat is de site structuur die u in gedachten heeft? <i class="fa fa-info-circle text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="@lang('form.onboarding_menu_tooltip')"></i></h2>
										<h4 class="">Let op: niet alle velden hoeven ingevuld te worden.</h4>
									</div>
								...
								<div class="tab-pane" role="tabpanel" id="step4">
										<div class="row">
											...
											<div class="uploaded-files text-left col-md-6 col-md-offset-3">
												...
												<button type="button" class="btn btn-danger btn-link  p-0 file-remove" data-id="{{ $form->file()->id }}"><span class="fa fa-close text-danger"></span></button>
												<a href="{{ asset('uploads/' . $form->file()->media_name) }}" target="_blank">{{ $form->file()->media_name }}</a>
											</div>
											@endif
											<div class="form-group col-md-6 col-md-offset-3 mt-15 {{ $form->file() ? 'hide' : '' }}">
								...
								<div class="tab-pane" role="tabpanel" id="step6">
									<div class="row mb-30">
										<h2 class="text-dark-light">Welke bestaande websites / webshops spreken je aan?</h2>
								...
								<div class="tab-pane" role="tabpanel" id="step7">
									<div class="row mb-30">
										<h2 class="text-dark-light">Op welke <strong>zoekwoorden</strong> wil je gevonden worden op <strong>Google</strong>? <i class="fa fa-question-circle text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="@lang('form.onboarding_google_tooltip')"></i></h2>
										...
										<div class="col-md-12 demo-layout">
											<div class="row mt-30">
												<div class="col-md-6 p-15">
													<div class="row no-mh">
														<div class="col-md-12">
															<input type="radio" name="layout" id="layout_8" class="input-hidden" value="7" {{ $form->layout == 7 ? 'checked' : '' }}
															/>
															<label for="layout_8" class="layout-type">
																<img src="{{ asset('assets/img/demos/Webshop.jpg') }}" alt="" class="img-responsive"/>
															</label>
														</div>
													</div>
													<div class="row no-mh">
														<div class="col-md-6">
															<a href="http://webshop.iqscript.nl/" class="btn btn-success btn-round" target="__blank">Layout bekijken</a>
														</div>
														<div class="col-md-6">
															<h3 class="text-dark-light mb-0 mt-10">Webshop Simple</h3>
														</div>
													</div>
												</div>
												<div class="col-md-6 p-15">
													<div class="row no-mh">
														<div class="col-md-12">
															<input type="radio" name="layout" id="layout_9" class="input-hidden" value="8" {{ $form->layout == 8 ? 'checked' : '' }}
															/>
															<label for="layout_9" class="layout-type">
																<img src="{{ asset('assets/img/demos/Webshop-2.jpg') }}" alt="" class="img-responsive"/>
															</label>
														</div>
													</div>
													<div class="row no-mh mt-20">
														<div class="col-md-6">
															<a href="http://webshop2.iqscript.nl/" class="btn btn-success btn-round" target="__blank">Layout bekijken</a>
														</div>
														<div class="col-md-6">
															<h3 class="text-dark-light mb-0 mt-10">Webshop Small</h3>
														</div>
													</div>
												</div>
											</div>
											<div class="row mt-30">
												<div class="col-md-6 p-15">
													<div class="row no-mh">
														<div class="col-md-12">
															<input type="radio" name="layout" id="layout_1" class="input-hidden" value="0" {{ $form->layout == 0 ? 'checked' : '' }}
															/>
															<label for="layout_1" class="layout-type">
																<img src="{{ asset('assets/img/demos/Webshop-3.jpg') }}" alt="" class="img-responsive"/>
															</label>
														</div>
													</div>
													<div class="row no-mh">
														<div class="col-md-6">
															<a href="http://webshopv3.iqscript.nl/" class="btn btn-success btn-round" target="__blank">Layout bekijken</a>
														</div>
														<div class="col-md-6">
															<h3 class="text-dark-light mb-0 mt-10">Webshop Clean</h3>
														</div>
													</div>
												</div>
												<div class="col-md-6 p-15">
													<div class="row no-mh">
														<div class="col-md-12">
															<input type="radio" name="layout" id="layout_2" class="input-hidden" value="2" {{ $form->layout == 2 ? 'checked' : '' }}
															/>
															<label for="layout_2" class="layout-type">
																<img src="{{ asset('assets/img/demos/Webshop-4.jpg') }}" alt="" class="img-responsive"/>
															</label>
														</div>
													</div>
													<div class="row no-mh mt-20">
														<div class="col-md-6">
															<a href="http://webshopv2.iqscript.nl/" class="btn btn-success btn-round" target="__blank">Layout bekijken</a>
														</div>
														<div class="col-md-6">
															<h3 class="text-dark-light mb-0 mt-10">Webshop Dark</h3>
														</div>
													</div>
												</div>
											</div>
											<div class="row mt-30">
												<div class="col-md-6 p-15">
													<div class="row no-mh">
														<div class="col-md-12">
															<input type="radio" name="layout" id="layout_3" class="input-hidden" value="4" {{ $form->layout == 4 ? 'checked' : '' }}
															/>
															<label for="layout_83" class="layout-type">
																<img src="{{ asset('assets/img/demos/Webshop-5.jpg') }}" alt="" class="img-responsive"/>
															</label>
														</div>
													</div>
													<div class="row no-mh">
														<div class="col-md-6">
															<a href="http://webshopv1.iqscript.nl/" class="btn btn-success btn-round" target="__blank">Layout bekijken</a>
														</div>
														<div class="col-md-6">
															<h3 class="text-dark-light mb-0 mt-10">Webshop Big</h3>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="tab-pane" role="tabpanel" id="step9">
									<div class="row mb-30 no-mh">
										...
										<h4 class="text-dark-light"><strong>Let op: als je bij de vorige vraag een zakelijk mail hebt aangevraagd gebruik deze dan ook hier!</strong></h4>
									</div>
									<div class="row mb-20">
										...
										<div class="col-md-6 col-md-offset-3 form-group">
											<input type="text" name="kvk" id="kvk" class="input-md" placeholder="KvK (optioneel)" value="{{ $form->kvk ? $form->kvk : old('kvk') }}">
											@if ($errors->has('kvk'))
												<span class="error text-danger" for="kvk">{{ $errors->first('kvk') }}</span>
											@endif
										</div>
										<div class="col-md-6 col-md-offset-3 form-group">
											<input type="text" name="btw_num" id="btw_num" class="input-md" placeholder="BTW nummer (optioneel)" value="{{ $form->btw_num ? $form->btw_num : old('btw_num') }}">
											@if ($errors->has('btw_num'))
												<span class="error text-danger" for="btw_num">{{ $errors->first('btw_num') }}</span>
											@endif
										</div>
									</div>
									<ul class="list-inline">
									...
									<div class="row card-box">
										<div class="card col-md-3">
											<div class="card-body">
												...
												<div class="form-group">
													<input type="text" id="main_color" name="main_color" class="form-control color-picker" value="{{ $form->main_color }}">
												</div>
											</div>
										</div>
										<div class="card col-md-3">
											<div class="card-body">
												...
												<div class="form-group">
													<input type="text" id="sub_color_1" name="sub_color_1" class="form-control color-picker" value="{{ $form->sub_color_1 }}">
												</div>
											</div>
										</div>
										<div class="card col-md-3">
											<div class="card-body">
												...
												<div class="form-group">
													<input type="text" id="sub_color_2" name="sub_color_2" class="form-control color-picker" value="{{ $form->sub_color_2 }}">
												</div>
											</div>
										</div>
									</div>
									<div class="row no-mh">
										<div class="form-group col-md-6 col-md-offset-3 logo-color mb-30">
