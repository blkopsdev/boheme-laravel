                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="step0">
                                    <div class="tab-pane-title py-100">
                                        <h1 class="text-dark-light" style="font-size: 50px;">@lang('form.feedback_final_version')</h1>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step1">
                                    ...
                                    <div class="col-md-8 col-md-offset-2 text-left mt-30">
    ...
    $(document).on('click', '.delete-page', function() {
        ...
        for (let index = 0; index < elems.length; index++) {
            ...
            $(element).closest('.feedback-page').find('input[type="file"]').each(function() {
                $(this).attr('name', 'page_files[' + (index + 1) + '][]');
            })
        }
    });
