                        ...
                        <form method="POST" enctype="multipart/form-data" action="" class="multistep web-design">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step2">
                                    <div class="row">
                                        <h2 class="mb-15">@lang('app.website_type')</h2>
                                        <div class="form-group badge-checkboxes {{ $errors->has('type') ? ' has-danger' : '' }}">
                                            <div class="col-md-6 col-md-offset-3">
                                                <label class="checkbox-inline my-10">
                                                    <input type="checkbox" value="Dynamisch" name="type[]" @if($form->types && strpos($form->types ,'Dynamisch')) checked @endif
                                ...
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    <div class="row mb-30">
                                        <h2 class="text-dark-light">Wat zijn de USP's (Unique Selling Points) van je bedrijf? <i class="fa fa-question-circle text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="@lang('form.usp_tooltip')"></i></h2>
                                        <h4 class="text-dark-light mb-50"><strong>Denk aan: Gratis verzending, voor 16:00 besteld de volgende dag in huis etc.</strong></h4>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step4">
                                    <div class="row mb-30 no-mh">
                                        <h2 class="text-dark-light mb-15">Welke contact gegevens kunnen we gebruiken op de webshop?</h2>
                                    </div>
                                    <div class="row mb-20">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            ...
                                            {{ $form->font == 'Open Sans and Roboto' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            <input type="radio" name="font" 
                                            id="font_2" class="input-hidden" value="Playfair Display and Montserrat" {{ $form->font == 'Playfair Display and Montserrat' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            <input type="radio" name="font" 
                                            id="font_3" class="input-hidden" value="Lora and Alegreya" 
                                            {{ $form->font == 'Lora and Alegreya' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            <input type="radio" name="font" 
                                            id="font_4" class="input-hidden" value="Merriweather and Lato" {{ $form->font == 'Merriweather and Lato' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            <input type="radio" name="font" 
                                            id="font_5" class="input-hidden" value="Amatic SC and Josefin Slab" {{ $form->font == 'Amatic SC and Josefin Slab' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30">
                                            <input type="radio" name="font" 
                                            id="font_6" class="input-hidden" value="PT Sans Narrow and PT Sans" {{ $form->font == 'PT Sans Narrow and PT Sans' ? 'checked' : '' }}
                                            />
                                        ...
                                        <div class="col-md-8 col-md-offset-2 mt-30 text-left">
                                            <div class="font-card">
                                                ...
                                                <textarea name="font_description" id="font_description" cols="60" rows="5" class="p-15 form-control" placeholder="Type hier de naam van het lettertype of de URL van een voorbeeld website."></textarea>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step6">
                                    <div class="row appeals">
                                        ...
                                        <div class="col-md-12 mt-30 {{ $errors->has('appeal_1') ? ' has-danger' : '' }}">
                                            <input type="radio" name="appeal_1" 
                                            id="appeal_1_odd" class="input-hidden" value="0" 
                                            {{ $form->appeal_1 == 0 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_1_odd" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-5-0.jpg') }}" alt="" />
                                                </label>

                                            <input 
                                                type="radio" name="appeal_1"
                                                id="appeal_1_even" class="input-hidden"  value="1"
                                                {{ $form->appeal_1 == 1 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_1_even" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-5-1.jpg') }}" alt="" />
                                            </label>
                                        </div>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step7">
                                    <div class="row appeals">
                                        ...
                                        <div class="col-md-12 mt-30 {{ $errors->has('appeal_2') ? ' has-danger' : '' }}">
                                            <input type="radio" name="appeal_2" 
                                            id="appeal_2_odd" class="input-hidden" value="0" {{ $form->appeal_2 == 0 ? 'checked' : '' }}
                                            />
                                            ...
                                            <input 
                                                type="radio" name="appeal_2"
                                                id="appeal_2_even" class="input-hidden" value="1" {{ $form->appeal_2 == 1 ? 'checked' : '' }}
                                            />
                                ...
                                <div class="tab-pane" role="tabpanel" id="step8">
                                    <div class="row appeals">
                                        ...
                                        <div class="col-md-12 mt-30 {{ $errors->has('appeal_3') ? ' has-danger' : '' }}">
                                            <input type="radio" name="appeal_3" 
                                            id="appeal_3_odd" class="input-hidden" value="0" {{ $form->appeal_3 == 0 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_3_odd" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-6-0.jpg') }}" alt="" />
                                                </label>

                                            <input 
                                                type="radio" name="appeal_3"
                                                id="appeal_3_even" class="input-hidden" value="1" {{ $form->appeal_3 == 1 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_3_even" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-6-1.jpg') }}" alt="" />
                                            </label>
                                        </div>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step9">
                                    <div class="row appeals">
                                        ...
                                        <div class="col-md-12 mt-30 {{ $errors->has('appeal_4') ? ' has-danger' : '' }}">
                                            <input type="radio" name="appeal_4" 
                                            id="appeal_4_odd" class="input-hidden" value="0" {{ $form->appeal_4 == 0 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_4_odd" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-7-0.jpg') }}" alt="" />
                                                </label>

                                            <input 
                                                type="radio" name="appeal_4"
                                                id="appeal_4_even" class="input-hidden" value="1" {{ $form->appeal_4 == 1 ? 'checked' : '' }}
                                            />
                                            <label for="appeal_4_even" class="appeal-type">
                                                <img src="{{ asset('assets/img/webdesign-7-1.jpg') }}" alt="" />
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mt-30 col-md-12">
                                            <div class="btn-group team-section mt-30 mb-30" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-default btn-round next-step {{ $form->team == 1 ? 'active' : '' }}" for="team_no">
                                        ...
                                        <div class="form-group mt-30 col-md-12">
                                            <div class="btn-group newsletter-section mt-30 mb-30" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-default btn-round next-step {{ $form->newsletter == 0 ? 'active' : '' }}" for="newsletter_no">
                                                    <input type="radio" name="newsletter" value="0" id="newsletter_no" {{ $form->newsletter == 0 ? 'active' : '' }}> Nee
                                                </label>
                                            </div>
                                        </div>
                                    </div>
