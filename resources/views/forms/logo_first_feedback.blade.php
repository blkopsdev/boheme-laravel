                            ...
                            <div class="tab-content">
                                ...
                                {{-- <div class="tab-pane" role="tabpanel" id="step1">
                                    <div class="tab-pane-title">
                                        <h2 class="text-dark-light">Bekijk eerst de uitleg video voor deze stap. <br>Dit duurt 1 minuut</h2>
                                    </div>
                                    <div class="py-20">
                                        <iframe class="embed-responsive-item no-border" src="https://www.youtube.com/embed/xhybjeRciYg?rel=0" width="480" height="270"></iframe>
                                    </div>
