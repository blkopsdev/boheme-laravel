@extends('layouts.app', ['activePage' => 'transactions.this_year', 'titlePage' => __('Transactions of This Year')])
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{ __('Transactions of This Year') }}</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <script>
    $(document).ready(function() {
      $('#transactions').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('transactions_this_year_ajax') }}",
        columns: [
            {data: 'id', name: 'id'},
