@extends('layouts.app', ['activePage' => 'transactions.last_year', 'titlePage' => __('Transactions of Last Year')])
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{ __('Transactions of Last Year') }}</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <script>
    $(document).ready(function() {
      $('#transactions').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('transactions_last_year_ajax') }}",
        columns: [
            {data: 'id', name: 'id'},
